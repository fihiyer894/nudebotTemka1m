...
export const CONFIG = {
  ...
  replicate: {
    apiToken: 'PASTE_YOUR_REPLICATE_API_TOKEN_HERE',
  ...
  packages: {
    ...
    pkg_50: { id: 'pkg_50', title: '50 генераций', emoji: '👑', stars: 500, generations: 50 },
  },
  ...
  products: {
    w_evening_dress: {
      ...
      category: 'women',
      description:
        'a floor-length emerald green satin evening dress with a fitted bodice and thin straps',
    },
    w_trench_coat: {
      id: 'w_trench_coat',
      title: '🧥 Бежевый тренч',
      category: 'women',
      description:
        'a beige double-breasted trench coat, belted at the waist, knee length, classic tailoring',
    },
    w_denim_jacket: {
      id: 'w_denim_jacket',
      ...
      category: 'women',
      description:
        'an oversized light-wash denim jacket with dropped shoulders, worn over a plain white top',
    },
    w_linen_set: {
      id: 'w_linen_set',
      title: '🤍 Льняной костюм',
      category: 'women',
      description:
        'a white linen co-ord set: wide-leg tailored trousers and a cropped tailored blazer',
    },
    m_business_suit: {
      id: 'm_business_suit',
      ...
      category: 'men',
      description:
        'a charcoal grey slim-fit two-piece business suit worn with a white dress shirt',
    },
    m_leather_jacket: {
      id: 'm_leather_jacket',
      ...
      category: 'men',
      description:
        'a black leather biker jacket with silver zip details, worn over a dark t-shirt',
    },
    m_denim_jacket: {
      id: 'm_denim_jacket',
      title: '👖 Джинсовая куртка',
      category: 'men',
      description: 'a classic blue denim trucker jacket worn over a plain grey t-shirt',
    },
    m_streetwear_hoodie: {
      id: 'm_streetwear_hoodie',
      title: '🎽 Стритвир худи',
      category: 'men',
      description:
        'an oversized graphite hoodie paired with matching cargo trousers, streetwear style',
    },
  },
};
